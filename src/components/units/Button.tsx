...
const variants = {
  ...
  secondary: 'uppercase text-blue-600 dark:text-white bg-opacity-20 dark:bg-opacity-10 bg-blue-700 hover:dark:bg-opacity-20 hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
...
export const Button = ({ children, className, href, icon, size, type, variant = 'primary' }: Props) => {
  return (
    <a
      href={href ? href : "#"}
      type={type}
      className={cls(size ? sizes[size] : null ,
